...
// Test different Cloudmersive endpoints
async function testCloudmersiveEndpoints() {
  try {
    console.log('🧪 Testing different Cloudmersive endpoints...');
    ...
    const endpoints = [
      ...
      'https://api.cloudmersive.com/convert/pdf/to/text',
      'https://api.cloudmersive.com/convert/pdf/to/text/string',
      'https://api.cloudmersive.com/ocr/pdf/toText/string'
    ];
