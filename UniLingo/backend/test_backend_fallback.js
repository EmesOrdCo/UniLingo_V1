...
// Test the backend endpoint with fallback
async function testBackendWithFallback() {
  try {
    console.log('🧪 Testing backend PDF extraction with fallback...');
