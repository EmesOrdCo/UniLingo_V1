...
interface TypeWhatYouHearSetupProps {
  visible: boolean;
  onClose: () => void;
  onStartGame: (options: TypeWhatYouHearSetupOptions) => void;
  availableCards: number;
}

const TypeWhatYouHearSetup: React.FC<TypeWhatYouHearSetupProps> = ({
  visible,
  onClose,
  onStartGame,
  availableCards,
...
export default TypeWhatYouHearSetup;
