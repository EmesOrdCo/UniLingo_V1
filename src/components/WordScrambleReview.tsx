...
const WordScrambleReview: React.FC<WordScrambleReviewProps> = ({
  visible,
  onClose,
  onPlayAgain,
  gameResults,
  ...
  const getScoreMessage = (score: number) => {
    if (score >= 90) return 'Word Wizard! ✨';
    if (score >= 80) return 'Great unscrambling! 🎯';
    ...
    >
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Word Scramble Results</Text>
              ...
              <View key={index} style={styles.wordCard}>
                ...
                <View style={styles.wordContent}>
                  <View style={styles.scrambledSection}>
                    <Text style={styles.scrambledLabel}>Scrambled:</Text>
                    <Text style={styles.scrambledText}>{word.scrambled}</Text>
                  </View>
                  
                  <View style={styles.answerSection}>
                    <View style={styles.correctAnswer}>
                      <Text style={styles.answerLabel}>Correct Answer:</Text>
                      <Text style={styles.answerText}>{word.correct}</Text>
                    </View>
                    {!word.isCorrect && (
