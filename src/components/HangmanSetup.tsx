...
interface HangmanSetupProps {
  visible: boolean;
  onClose: () => void;
  onStartGame: (options: HangmanSetupOptions) => void;
  availableCards: number;
}

const HangmanSetup: React.FC<HangmanSetupProps> = ({
  visible,
  onClose,
  onStartGame,
  availableCards,
    ...
    >
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>{t('gameSetup.title.hangman')}</Text>
        ...
        <View style={styles.content}>
          ...
          <TouchableOpacity style={styles.startButton} onPress={handleStartGame}>
            <Text style={styles.startButtonText}>{t('gameSetup.buttons.startHangman')}</Text>
