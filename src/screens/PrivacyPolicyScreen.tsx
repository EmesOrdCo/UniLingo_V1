    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            <Text style={styles.bold}>Application</Text> refers to UniLingo, the software program provided by the Company.
          </Text>
          <Text style={styles.paragraph}>
            <Text style={styles.bold}>Company</Text> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to EmesOrd Ltd, 50 Westfield Avenue, Watford, WD24 7EH.
          </Text>
          <Text style={styles.paragraph}>
            <Text style={styles.bold}>Country</Text> refers to: United Kingdom
          </Text>
          <Text style={styles.paragraph}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            <Text style={styles.bold}>By email:</Text> unilingo.help@gmail.com
          </Text>
        </View>
